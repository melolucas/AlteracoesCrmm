...
class Help extends MY_Controller {
    ...
    function help_articles() { //Ajuda 1: Artigos
        $this->access_only_allowed_members();
    ...
    function knowledge_base_articles() { //Ajuda 2: Artigos
        $this->access_only_allowed_members();
    ...
    //show help articles list
    function help_categories() { //Ajuda 1: Categorias
        $this->access_only_allowed_members();
    ...
    //show knowledge base articles list
    function knowledge_base_categories() { //Ajuda 2: Categorias
        $this->access_only_allowed_members();
    ...
    function save_category() {
        ...
        $data = array(
            ...
            "role_id" => $this->login_user->role_id //Atribui o role_id de quem criou a categoria
        );
    ...
    function save_article() {
        ...
        $data = array(
            ...
            "status" => $this->input->post('status'),
            "role_id" => $this->login_user->role_id //Atribui o role id de quem escreveu o artigo
        );
